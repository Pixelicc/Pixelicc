...
try {
  ...
  const weatherHuman = `${location.weather.temperature.current.toFixed(1)} °C and ${location.weather.isRaining ? "rainy 🌧️" : location.weather.isSnowing ? "snowy 🌨️" : location.weather.cloudCover > 95 ? "cloudy ☁️" : location.weather.cloudCover > 85 ? "partially cloudy 🌥️" : location.weather.cloudCover > 75 ? "partially cloudy ⛅" : "clear"}`;
